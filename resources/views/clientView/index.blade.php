        ...
        <div class="container">
            ...
            <section class="showDishes">
                ...
                <div class="categories">
                    <div class="category">
                        <img src="{{ asset('img/bakery_food_baker_sweet_dessert_cupcake_icon_253935.svg') }}" alt="">
                        <span>Bakery</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/burguer-svgrepo-com.svg') }}" alt="">
                        <span>Burguer</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/4053429-beverage-coffee-cup-drink-food-hot_113464.svg') }}" alt="">
                        <span>Beverage</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/chicken-fast-fastfood-svgrepo-com.svg') }}" alt="">
                        <span>Chicken</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/bakery_food_baker_sweet_dessert_cupcake_icon_253935.svg') }}" alt="">
                    ...
                    <div class="category">
                        <img src="{{ asset('img/pizza-svgrepo-com.svg') }}" alt="">
                        <span>Pizza</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/fish-svgrepo-com.svg') }}" alt="">
                        <span>Sea Food</span>
                    </div>
                    <div class="category">
                        <img src="{{ asset('img/chicken-fast-fastfood-svgrepo-com.svg') }}" alt="">
                ...
                <div class="allDishesToday">
                    ...
                    <div class="containerAll">
                        ...
                        @foreach($dishes as $dish)
                            <div class="dish">
                                <img class="imageCard" src="{{ asset('img/'. $dish['img']) }}" alt="">
                                <div class="more">
                                    <div class="details">
                                        <span>{{ $dish['name'] }}</span>
